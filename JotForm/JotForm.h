 ...
 * Returns user account type, avatar URL, name, email, website URL and
 * account limits.
 */
 ...
 * Returns number of submissions, number of SSL form submissions,
 ...
 * Returns name of the folder and owner of the folder for shared
 * folders.
 */
 ...
 * Returns a list of forms in a folder, and other details about the form
 ...
 * Return changes on user settings
 */
 ...
 * Returns activity log about things like forms
 ...
 * Returns form ID, status, update and creation dates, submission count
 * etc.
 */
 ...
 * Returns properties of new questions.
 */
...
/**
 * Returns wether or not a account is running on a EU server.
 */
 ...
 * Get details regarding systems plan
 */
