...
- (void)createReport:(int64_t)formID reportParams:(NSDictionary * _Nonnull)reportParams onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
- (void)createSuggestion:(int64_t)formID suggestionParams:(NSDictionary * _Nonnull)suggestionParams onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
- (void)login:(NSDictionary * _Nonnull)userinfo onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
- (void)logout:(NSDictionary * _Nonnull)userinfo onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
- (void)registerUser:(NSDictionary * _Nonnull)userinfo onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
...
- (void)updateSettings:(NSDictionary * _Nonnull)settings onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
...
- (void)getFormSubmissions:(int64_t)formID offset:(NSInteger)offset limit:(NSInteger)limit orderBy:(NSString * _Nonnull)orderBy filter:(NSDictionary * _Nonnull)filter onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
...
- (void)createFormSubmissions:(int64_t)formID submission:(NSDictionary * _Nonnull)submission onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
...
- (void)createFormQuestion:(int64_t)formID question:(NSDictionary * _Nonnull)question onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
...
- (void)editFormQuestion:(int64_t)formID questionID:(int64_t)qid questionProperties:(NSDictionary * _Nonnull)properties onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
- (void)setFormProperties:(int64_t)formID formProperties:(NSDictionary * _Nonnull)properties onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
...
- (void)createForm:(NSDictionary * _Nonnull)form onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
- (void)createForms:(NSDictionary * _Nonnull)form onSuccess:(void (^ _Nonnull)(id _Nonnull))successBlock onFailure:(void (^ _Nonnull)(NSError * _Nonnull))failureBlock;
